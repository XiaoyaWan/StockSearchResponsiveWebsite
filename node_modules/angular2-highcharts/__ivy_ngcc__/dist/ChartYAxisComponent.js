...
ChartYAxisComponent.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ChartYAxisComponent, selectors: [["yAxis"]], outputs: { afterBreaks: "afterBreaks", afterSetExtremes: "afterSetExtremes", pointBreak: "pointBreak", pointInBreak: "pointInBreak", setExtremes: "setExtremes" } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ChartYAxisComponent, [{
        type: core_1.Directive,
        args: [{
                selector: 'yAxis'
            }]
    }], function () { return []; }, { afterBreaks: [{
            type: core_1.Output
        }], afterSetExtremes: [{
            type: core_1.Output
        }], pointBreak: [{
